...
#plot 3
png(filename = "./Exploratory/plot3.png", width = 480, height = 480)

par(mfrow = c(1,1))
with(elec, plot(datetime, Sub_metering_1, type = "S", ylab = "Energy sub metering", xlab = ""))
lines(elec$datetime, elec$Sub_metering_2, type = "S", col = "red")
lines(elec$datetime, elec$Sub_metering_3, type = "S", col = "blue")
